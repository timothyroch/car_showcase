...
import OptionQ11 from './_components/OptionQ11';

interface QuestionProps {
  onAnswer: (answer: string) => void;
}

const Question11: React.FC<QuestionProps> = ({ onAnswer }) => {
  const [selectedOptions, setSelectedOptions] = useState<string[]>([]);

  return (
    <div className="p-6 bg-white rounded-lg shadow-md max-w-md mx-auto">
      <h3 className="text-2xl font-semibold mb-4">Quels sont les points les plus importants pour votre prochain véhicule?</h3>
      <OptionQ11 onChange={setSelectedOptions} />
