...
import OptionQ13 from './_components/OptionQ13';

interface QuestionProps {
  onAnswer: (answer: string) => void;
}

const Question19: React.FC<QuestionProps> = ({ onAnswer }) => {
  const [selectedOption, setSelectedOption] = useState<string>('');

  return (
    <div className="p-6 bg-white rounded-lg shadow-md max-w-md mx-auto">
      <h3 className="text-2xl font-semibold mb-4">Quand avez-vous besoin de ce nouveau véhicule?</h3>
      
      <OptionQ13 onChange={setSelectedOption} />
